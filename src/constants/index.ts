export const openRouterAPIModels: openRouterAPIModelsI[] = [
  {
  ...
  { modelName: "Quasar Alpha", id: "openrouter/quasar-alpha" },
  {
    modelName: "DeepSeek: DeepSeek V3 Base (free)",
    id: "deepseek/deepseek-v3-base:free",
  },
  { modelName: "AllenAI: Molmo 7B D (free)", id: "allenai/molmo-7b-d:free" },
  {
  ...
  { modelName: "Qwerky 72B (free)", id: "featherless/qwerky-72b:free" },
  {
    modelName: "Mistral: Mistral Small 3.1 24B (free)",
    id: "mistralai/mistral-small-3.1-24b-instruct:free",
  },
  { modelName: "OlympicCoder 7B (free)", id: "open-r1/olympiccoder-7b:free" },
  { modelName: "OlympicCoder 32B (free)", id: "open-r1/olympiccoder-32b:free" },
  { modelName: "Google: Gemma 3 1B (free)", id: "google/gemma-3-1b-it:free" },
  { modelName: "Google: Gemma 3 4B (free)", id: "google/gemma-3-4b-it:free" },
  { modelName: "Google: Gemma 3 12B (free)", id: "google/gemma-3-12b-it:free" },
  { modelName: "Reka: Flash 3 (free)", id: "rekaai/reka-flash-3:free" },
  { modelName: "Google: Gemma 3 27B (free)", id: "google/gemma-3-27b-it:free" },
  {
    modelName: "DeepSeek: DeepSeek R1 Zero (free)",
    id: "deepseek/deepseek-r1-zero:free",
  },
  { modelName: "Qwen: QwQ 32B (free)", id: "qwen/qwq-32b:free" },
  {
  ...
  { modelName: "DeepSeek: R1 (free)", id: "deepseek/deepseek-r1:free" },
  {
  ...
  { modelName: "Google: Gemma 2 9B (free)", id: "google/gemma-2-9b-it:free" },
  {
